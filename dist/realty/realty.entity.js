...
const realty_details_entity_1 = require("../realty_details/realty_details.entity");
...
__decorate([
    (0, typeorm_1.OneToOne)(() => realty_details_entity_1.RealtyDetailsEntity, (details) => details.realty, { cascade: true, eager: true }),
